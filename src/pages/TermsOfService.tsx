      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8">
          <div className="prose dark:prose-invert max-w-none">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Agreement to Terms</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              By accessing and using NovelNest, you accept and agree to be bound by the terms and
              provision of this agreement. If you do not agree to abide by the above, please do not use this service.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Description of Service</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">User Accounts</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Content Guidelines</h2>
            ...
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Content Standards</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Intellectual Property</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Prohibited Uses</h2>
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Content Moderation</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Privacy Policy</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Your privacy is important to us. Please review our Privacy Policy, which also governs your use of the
              service, to understand our practices.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Disclaimers</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Limitation of Liability</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Termination</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Governing Law</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Changes to Terms</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision
              is material, we will provide at least 30 days notice prior to any new terms taking effect.
            </p>

            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 mt-8">Contact Information</h2>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              If you have any questions about these Terms of Service, please contact us at:
            </p>
            <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
              <p className="text-gray-600 dark:text-gray-300">
                Email: legal@novelnest.com
              </p>
            </div>
          </div>
        </div>
