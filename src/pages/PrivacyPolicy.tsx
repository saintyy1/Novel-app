      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gray-800 rounded-xl shadow-md p-8">
          <div className="prose-invert max-w-none">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Information We Collect</h2>
            ...
            <p className="text-gray-300 mb-6">This information may include:</p>
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Data Security</h2>
            <p className="text-gray-300 mb-6">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 mt-8">Your Rights and Choices</h2>
