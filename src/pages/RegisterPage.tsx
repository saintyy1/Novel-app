          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              <div>
                <Link
                  to="#"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-600 rounded-md shadow-sm bg-gray-700 text-sm font-medium text-gray-200 bg-gray-600 transition-colors duration-200"
                >
              ...
              <div>
                <Link
                  ...
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-600 rounded-md shadow-sm bg-gray-700 text-sm font-medium text-gray-200 hover:bg-gray-600 transition-colors duration-200"
                >
                  <svg className="h-5 w-5 text-[#24292E] dark:text-white" fill="currentColor" viewBox="0 0 24 24">
