...
const Profile = () => {
  ...
  // Prevent background scrolling when Novel modal is open
  useEffect(() => {
    if (showEditModal) {
      document.body.style.overflow = "hidden"
    } else {
                          ...
                          {openKebabMenu === novel.id && (
                            <div className="absolute top-full mt-1 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-10 min-w-[140px]">
                              ...
                              <Link
                                ...
                                className="w-full px-3 py-2 text-left text-sm text-purple-400 hover:text-purple-300 hover:bg-gray-700 flex items-center gap-2"
                              >
